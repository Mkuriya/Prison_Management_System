...
if(isset($_GET['id'])){
    ...
    $query = "SELECT * FROM officer WHERE id=:id LIMIT 1";
...
<div class="main">
        <div class="book-list-container">
            <div class="container-header row mb-3">
                <div class="col">
                    <h3>Update Officer Information</h3>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pword" value="<?= $result->pword;?>" >
                </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" name="update-officer">UPDATE</button>
                        <a href="a_off_home.php"><button type="button" class="btn btn-secondary ml-5" >CANCEL</button></a>
                    </div>
                </form>
            </div>
        </div>
