...
if(isset($_GET['id'])){
    ...
    $query = "SELECT * FROM jailer WHERE id=:id LIMIT 1";
...
<div class="main">
        <div class="book-list-container">
            <div class="container-header row mb-3">
                <div class="col">
                    <h3>Update Jailer Information</h3>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" name="update-jailer">UPDATE</button>
                        <a href="a_jai_home.php"><button type="button" class="btn btn-secondary ml-5" >CANCEL</button></a>
                    </div>
                </form>
            </div>
        </div>
