...
<body>
    ...
    <?php
                     if(isset($_GET['id'])){
                        ...
                        $query = "SELECT * FROM adb WHERE aid=:id LIMIT 1";
               ...
               <form action="cud.php" method="POST" class="form-container">
                            ...
                            <input type="text" name="aln" value="<?= $result->aln;?>">
                            </div>
                            <div class="name_hold">
                            <label for="afn"> First Name:</label>
                            <input type="text" name="afn" value="<?= $result->afn;?>">
                            </div>              
                            <div class="name_hold">
                            <label for="amn">Middle Name:</label>
                            <input type="text" name="amn" value="<?= $result->amn;?>">
                            </div>
                            <div class="name_hold">
                            <label for="aun">Username:</label>
                            <input type="text" name="aun" value="<?= $result->aun;?>">
                            </div>
                            <div class="name_hold">
                            <label for="apw">Password:</label>
                            <input type="text" name="apw" value="<?= $result->apw;?>">
                            </div>
                            <div class="name_hold">
                            <label for="aem">Email:</label>
                            <input type="text" name="aem" value="<?= $result->aem;?>">
                            </div>
                            <br>
                <button type="submit" class="btn" name="update-aaac-btn">Save</button>
