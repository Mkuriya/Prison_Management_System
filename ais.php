...
$sql = "SELECT * FROM indb WHERE inln LIKE :searchTerm OR 
infn LIKE :searchTerm OR
inmn LIKE :searchTerm OR
inpc LIKE :searchTerm"; 
...
<body>
    ...
    <div class="btn_hold">
        ...
        <div class="backbtn">
                    <a href="aihome.php"><button>Back</button></a>
                </div>   
            </div>         
            <table>
            <tr>
            ...
            <?php foreach ($results as $row): ?>
                <tr>
                    <td><?php echo $row['inln'], ',', $row['infn'], ',', $row['inmn']; ?></td>
                    <td><?php echo $row['inpc']; ?></td>
                </tr>
                <?php endforeach; ?>
        </table>
    </div>
